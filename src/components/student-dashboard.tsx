            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">iPhone found in Library</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">Backpack returned to owner</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">Keys found in Student Center</p>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="p-3 bg-emerald-50 rounded-lg">
                  <p className="text-sm font-medium text-emerald-800">Be Specific</p>
                  <p className="text-xs text-emerald-600">Include detailed descriptions and exact locations</p>
                </div>
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm font-medium text-blue-800">Check Regularly</p>
                  <p className="text-xs text-blue-600">New items are added daily - check back often</p>
                </div>
                <div className="p-3 bg-purple-50 rounded-lg">
                  <p className="text-sm font-medium text-purple-800">Contact Info</p>
                  <p className="text-xs text-purple-600">Keep your contact information up to date</p>
                </div>
              </div>
            </CardContent>
          </Card>
